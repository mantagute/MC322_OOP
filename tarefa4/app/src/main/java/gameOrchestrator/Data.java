...
public class Data {
    ...
    public static final List<EffectCard> heroEffectCards(Publisher publisher) {
        return List.of(
            new EffectCard("The one, the only.", 3, "É o tal do 01", EffectType.STRENGTH, 2, true, publisher, false),
            new EffectCard("Moggar", 1, "Não está sobrando nada...", EffectType.POISON, 10, false, publisher, true)
        );
    }

    public static final List<EffectCard> azoideEffectCards(Publisher publisher) {
        return List.of(
            new EffectCard("Ancestrais Paraenses", 3, "Todo o know-how do interior invocado", EffectType.STRENGTH, 2, true, publisher, false),
            new EffectCard("AET", 1, "Cuidado para não se contaminar...", EffectType.POISON, 10, false, publisher, false)
        );
    }

    public static final List<EffectCard> bzoideEffectCards(Publisher publisher) {
        return List.of(
            new EffectCard("Girl", 3, "Na frente dela, não pode passar vergonha", EffectType.STRENGTH, 2, true, publisher, false),
            new EffectCard("Curitiba way of life", 1, "Não brinque com os sulistas...", EffectType.POISON, 10, false, publisher, true)
        );
    }
